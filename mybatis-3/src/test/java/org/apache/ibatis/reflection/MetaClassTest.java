...
public class MetaClassTest {
	...
	public void shouldFindPropertyName() {
		ReflectorFactory reflectorFactory = new DefaultReflectorFactory();
		MetaClass meta = MetaClass.forClass(RichType.class, reflectorFactory);
		assertEquals("richField", meta.findProperty("richType.richType.richMap"));
	}
	...
	public void mytest() {
		ReflectorFactory reflectorFactory = new DefaultReflectorFactory();
		MetaClass meta = MetaClass.forClass(RichType.class, reflectorFactory);
		String s = meta.findProperty("richType.richType.richMap");
		System.out.println(s);
		boolean b = meta.hasGetter("richType.richList[0].richMap");
